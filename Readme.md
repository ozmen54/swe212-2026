...
<table>
  ...
  <body>
    ...
    <tr>
      ...
      <td>
        <b>a)</b> Build the app using Java 25, Spring Boot freamework (version 4.0.1) and Maven (version 4.0.0) build tool.<br> 
